                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-5">
                            <?php echo Form::open(['id'=>'createTargetReport','class'=>'ajax-form']); ?>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div id="reportrange" class="btn default">
                                        ...
                                        <span id="date"><?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->toFormattedDateString()); ?> - <?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->toFormattedDateString()); ?> </span>
...
<?php $__env->startSection('footer'); ?>
    ...
    <?php echo HTML::script('admin/global/plugins/datatables/DataTables-1.10.11/media/js/jquery.dataTables.js'); ?>

    <?php echo HTML::script('admin/global/plugins/datatables/DataTables-1.10.11/media/js/dataTables.bootstrap.js'); ?>

    <?php echo HTML::script('admin/global/plugins/datatables/Responsive-2.0.2/js/dataTables.responsive.js'); ?>

    <?php echo HTML::script('admin/global/plugins/datatables/Responsive-2.0.2/js/responsive.bootstrap.js'); ?>
...
//                    },
    ...
    <script>
        $('#save-form').click(function(){
            ...
            if(client ==''){
                ...
                $.easyAjax({
                    url:'<?php echo e(route('gym-admin.client-report.store')); ?>',
                    container:'#createTargetReport',
                    type:"POST",
                    data:{date_range:dateRange,client_type:client,_token:'<?php echo e(csrf_token()); ?>'},
    ...
    <script>
        function load_data_table(id,s,e){
            ...
            var url = '<?php echo e(route('gym-admin.client-report.ajax-create',['#id','#s','#e'])); ?>';
    ...
    <script>
        $('#targetDataTable').on('click','.viewClient',function(){
            var id = $(this).data('id');
            var show_url = '<?php echo e(route('gym-admin.client-report.show',['#id'])); ?>';
