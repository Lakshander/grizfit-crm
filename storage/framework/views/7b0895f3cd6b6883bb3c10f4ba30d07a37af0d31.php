                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <?php if($merchantSetting == ''): ?>
                                                <img id="changeProfile" src="<?php echo e(asset('/fitsigma/images/').'/'.'fitsigma-logo-full-red.png'); ?>" alt="" />
                                            <?php elseif($merchantSetting->image == ''): ?>
                                                <img src="<?php echo e(asset('/fitsigma/images/').'/'.'fitsigma-logo-full-red.png'); ?>" alt="" />
                                            <?php else: ?>
                                                <?php if($gymSettings->local_storage == '0'): ?>
                                                    <img id="changeProfile" src="<?php echo e($gymSettingPath.$merchantSetting->image); ?>" alt="" />
                                                <?php else: ?>
                                                    <img id="changeProfile" src="<?php echo e(asset('/uploads/gym_setting/master/').'/'.$merchantSetting->image); ?>" alt="" />
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php else: ?>
                                                    <img id="loginImage" src="<?php echo e(asset('/uploads/gym_setting/master/').'/'.$merchantSetting->front_image); ?>" alt="" />
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                            ...
                            <div class="form-group form-md-line-input hidden-xs hidden-sm">
                                ...
                                <div class="input-icon right">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <?php if($merchantSetting == ''): ?>
                                                <img id="customerImage" src="<?php echo e(asset('/fitsigma/images/').'/'.'fitsigma-logo-full-red.png'); ?>" alt="" />
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php else: ?>
                                                    <img id="customerImage" src="<?php echo e(asset('/uploads/gym_setting/master/').'/'.$merchantSetting->customer_logo); ?>" alt="" />
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
        ...
        function uploadLoginImage(input) {
            ...
            $.ajax({
                ...
                function( response ) {
                    ...
                    <?php else: ?>
                        $('#loginImage').attr('src', "<?php echo e(asset('/uploads/gym_setting/master/')); ?>"+ '/' + obj.image);
                    <?php endif; ?>
                    $('.popover ').hide();
                });
        }
        ...
        function uploadImage() {
            ...
            $.ajax({
                ...
                function( response ) {
                    ...
                    <?php else: ?>
                        $('#changeProfile').attr('src', "<?php echo e(asset('/uploads/gym_setting/master/')); ?>"+ '/' + obj.image);
                        var data = '<div class="profile-big-container"> <img src="<?php echo e(asset('/uploads/gym_setting/master/')); ?>'+ '/' + obj.image + '" class="profile-img-big"><span rel="change" class="change-photo" onclick="forImage(this)">Change Photo</span></div>';
                        $('.changeAfterProfile').attr('src', "<?php echo e(asset('/uploads/gym_setting/thumb/')); ?>"+ '/' + obj.image);
                        $('.image-change').attr('src', "<?php echo e(asset('/uploads/gym_setting/master/')); ?>"+ '/' + obj.image);
                        profile = '<img src="<?php echo e(asset('/uploads/gym_setting/thumb/')); ?>'+ '/' + obj.image + '">';
                    <?php endif; ?>
                    $('.popover ').hide();
                });
        }
        ...
        function uploadCustomerImage()
        {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    <?php else: ?>
                    $('#customerImage').attr('src', "<?php echo e(asset('/uploads/gym_setting/master/')); ?>"+ '/' + obj.image);
                    <?php endif; ?>
                }
            })
        }
