                            ...
                            <div class="profile-userpic">
                                <?php if($client->image != ''): ?>
                                    <?php if($gymSettings->local_storage == 0): ?>
                                        <img id="changeProfile" src="<?php echo e($profileHeaderPath.$client->image); ?>" class="img-responsive image-change-profile" />
                                    <?php else: ?>
                                        <img id="changeProfile" src="<?php echo e(asset('/uploads/profile_pic/master/').'/'.$client->image); ?>" class="img-responsive image-change-profile" />
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img src="<?php echo e(asset('/fitsigma/images/').'/'.'user.svg'); ?>" class="img-responsive image-change-profile" alt="">
                                <?php endif; ?>
                            </div>
                            <!-- END SIDEBAR USERPIC -->
                            <!-- SIDEBAR USER TITLE -->
                            <div class="profile-usertitle">
                                <div class="profile-usertitle-name"> <?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?> </div>
                            </div>
                                                ...
                                                <input type="hidden" name="type" value="general">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input type="text" placeholder="First Name" class="form-control" name="first_name" id="first_name" value="<?php echo e($client->first_name); ?>" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label>Last Name</label>
                                                            <input type="text" placeholder="Last Name" class="form-control" name="last_name" id="last_name" value="<?php echo e($client->last_name); ?>" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input type="tel" placeholder="Mobile Number" name="mobile" id="mobile" class="form-control" value="<?php echo e($client->mobile); ?>"/>
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label>Email</label>
                                                            <input type="email" placeholder="Email" name="email" id="email" class="form-control" value="<?php echo e($client->email); ?>"/>
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            <label>Address</label>
                                                            <textarea class="form-control" name="address" id="address" rows="6"><?php echo e($client->address); ?></textarea>
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <div class="form-group form-md-line-input">
                                                                <div class="form/group form-md-radios">
                                                                    ...
                                                                    <div class="md-radio-inline">
                                                                        <div class="md-radio">
                                                                            <input type="radio" value="yes" id="yes_radio" name="marital_status" class="md-radiobtn" <?php if($client->marital_status == 'yes'): ?> checked <?php endif; ?>>
                                                                            <label for="yes_radio">
                                                                                <span></span>
                                                                        ...
                                                                        <div class="md-radio ">
                                                                            <input type="radio" value="no" id="no_radio" name="marital_status" class="md-radiobtn" <?php if($client->marital_status == 'no'): ?> checked <?php endif; ?>>
                                                                            <label for="no_radio">
                                                                                <span></span>
                                                                                <span class="check"></span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group form-md-line-input ">
                                                                        <input type="number" min="0" class="form-control" id="height_feet" name="height_feet" placeholder="feet" value="<?php echo e($client->height_feet); ?>">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group form-md-line-input ">
                                                                        <input type="number" min="0" class="form-control" id="height_inches" name="height_inches" placeholder="inches" value="<?php echo e($client->height_inches); ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            <label>Age</label>
                                                            <input type="number" placeholder="Age" class="form-control" name="age" value="<?php echo e($age); ?>" id="age" readonly/>
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label>Weight</label>
                                                            <input type="number" min="0" placeholder="Weight" class="form-control" name="weight" id="weight" value="<?php echo e($client->weight); ?>" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <select class="form-control edited" id="gender" name="gender">
                                                                ...
                                                                <option value="male" <?php if($client->gender == 'male'): ?>selected <?php endif; ?> >Male</option>
                                                                <option value="female" <?php if($client->gender == 'female'): ?>selected <?php endif; ?>>Female</option>
                                                            </select>
                                                            <span class="help-block"></span>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input readonly class="form-control form-control-inline input-medium date-picker" placeholder="Date of Birth" size="16" type="text" <?php if(!is_null($client) && isset($client->dob)): ?> value="<?php echo e($client->dob->format('m/d/Y')); ?>" <?php endif; ?> id="dob" name="dob" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group" id="anniversaryDiv">
                                                            <label>Anniversary</label>

                                                            <input readonly class="form-control form-control-inline input-medium date-picker" placeholder="Anniversary" size="16" type="text" value="<?php if(!is_null($client->anniversary)): ?><?php echo e($client->anniversary->format('m/d/Y')); ?><?php endif; ?>" id="anniversary" name="anniversary" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                <?php if($client->image == ''): ?>
                                                                    <img id="changeMainProfile" src="<?php echo e(asset('/fitsigma/images/').'/'.'user.svg'); ?>" alt="" />
                                                                <?php else: ?>
                                                                    <?php if($gymSettings->local_storage == 0): ?>
                                                                        <img id="changeMainProfile" src="<?php echo e($profileHeaderPath.$client->image); ?>" alt="" />
                                                                    <?php else: ?>
                                                                        <img id="changeMainProfile" src="<?php echo e(asset('/uploads/profile_pic/master/').'/'.$client->image); ?>" alt="" />
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            </div>
                                            ...
                                            <div class="tab-pane" id="tab_1_3">
                                                <div class="portlet light form-fit ">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                            <div class="btn-group">
                                                                <a id="sample_editable_1_new" href="<?php echo e(route('gym-admin.client-purchase.user-create', $client->id)); ?>" class="btn sbold dark"> Add New
                                                                        ...
                                                                        <div class="mt-element-list">
                                                                            <div class="mt-list-head list-news ext-1 font-white bg-dark">
                                                                                <div class="list-head-title-container">
                                                                                    <h3 class="list-title"><?php echo e(ucwords('memberships')); ?></h3>
                                                                                </div>
                                                                                <div class="list-count pull-right bg-red"><?php echo e(count($memberships)); ?></div>
                                                                            </div>
                                                                                    ...
                                                                                    <?php $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <li class="mt-list-item col-xs-12" id="mem-<?php echo e($mem['id']); ?>">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-xs-6 col-md-2">
                                                                                                    <span class="label label-info uppercase"> <?php echo e($mem['name']); ?> </span>
                                                                                                </div>
                                                                                                <div class="col-xs-12 col-md-2">
                                                                                                    <span class="visible-xs sbold col-xs-6 no-padding">Start Date:</span> <?php echo e($mem['start_date']); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        table.dataTable({
            responsive: true,
            "sAjaxSource": "<?php echo e(route('gym-admin.client.ajax-payments',$client->id)); ?>",
            bDestroy:true,
            "aoColumns": [
        ...
        $.ajax({
          ...
          function( response ) {
              ...
              <?php else: ?>
                  ...
                  $('#changeMainProfile').attr('src', "<?php echo e(asset('/uploads/profile_pic/master/')); ?>"+ '/' + obj.image);
              <?php endif; ?>
              $('.popover ').hide();
          });
      }
    ...
    <script>
        ...
        $('#save-webcam-image').click(function () {
            ...
            var uploadUrl = '<?php echo e(route("gym-admin.client.save-webcam-image", [ $client->id ])); ?>';

            Webcam.upload( data_uri, uploadUrl,null, '<?php echo e(csrf_token()); ?>');
        });
