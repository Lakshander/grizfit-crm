                                    ...
                                    <div class="col-xs-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2">
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="sub-total">0</span>
                                            </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2">
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="discount">0</span>
                                            </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2">
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="tax">0</span>
                                            </p>
                                        ...
                                        <div class="row margin-top-5 sbold">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2">
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="total">0</span>
                                            </p>
                                        ...
                                        <div class="row margin-top-5">
                                            <div class="form-group col-md-2 col-md-offset-10">
                                                ...
                                                <input type="text" readonly class="form-control" name="generated_by"
                                                       id="generated_by"
                                                       value="<?php echo e(ucwords($user->first_name.' '.$user->last_name)); ?>">
