                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-5">
                            <?php echo Form::open(['id'=>'balanceReport','class'=>'ajax-form']); ?>

                            <div class="form-body">
                                <div class="form-group">
                                    <div id="balancerange" class="btn default">
                                        <i class="fa fa-calendar"></i> &nbsp;
                                        <span id="date"><?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->subMonths(6)->toFormattedDateString()); ?> - <?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->toFormattedDateString()); ?> </span>
                ...
                <div class="col-md-6">
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                        ...
                        <div class="widget-thumb-wrap">
                            ...
                            <div class="widget-thumb-body">
                                <span class="widget-thumb-subtitle"><i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i></span>
                                <span class="widget-thumb-body-stat" data-counter="counterup" data-value="1,293" id="totalIncome"><?php echo e(round($income, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                        ...
                        <div class="widget-thumb-wrap">
                            ...
                            <div class="widget-thumb-body">
                                <span class="widget-thumb-subtitle"><i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i></span>
                                <span class="widget-thumb-body-stat" data-counter="counterup" data-value="1,293" id="totalExpense"><?php echo e(round($expense, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.reset').click(function() {
                var startDate = "<?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->subMonths(6)->toFormattedDateString()); ?>";
                var endDate = "<?php echo e(\Carbon\Carbon::now('Asia/Calcutta')->toFormattedDateString()); ?>";
        ...
        function getData() {
            ...
            $.easyAjax({
                type: "GET",
                url: "<?php echo e(route('gym-admin.balance-report.create')); ?>",
                data: {
                    startDate: startDate,
                    endDate: endDate
                },
