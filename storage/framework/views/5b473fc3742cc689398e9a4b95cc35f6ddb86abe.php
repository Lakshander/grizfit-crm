                            ...
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a id="sample_editable_1_new" href="<?php echo e(route('gym-admin.superadmin.branch')); ?>" class="btn sbold dark"> Add New
...
<script>
    ...
    table.dataTable({
        ...
        "serverSide": true,
        "processing": true,
        "ajax": "<?php echo e(route('gym-admin.superadmin.getData')); ?>",
        "aoColumns": [
