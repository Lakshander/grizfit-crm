<?php $__env->startSection('CSS'); ?>
    ...
    <?php echo HTML::style('admin/global/plugins/typeahead/typeahead.css'); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="client_name" id="client_name" placeholder="Enter Client Name" value="<?php echo e(ucwords($payment->client->first_name.' '.$payment->client->last_name)); ?>">
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-icon">
                                                    ...
                                                    <input type="text" class="form-control date-picker" readonly name="invoice_date" id="invoice_date" value="<?php echo e($payment->payment_date->format('m/d/Y')); ?>">
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" id="email" value="<?php echo e($payment->client->email); ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo e($payment->client->mobile); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Enter client address" name="client_address" id="client_address"><?php echo e($payment->client->address); ?></textarea>
                                        </div>
                                    </div>
                                </div>

                                <hr>
                                <?php if($gymSettings != '' && !is_null($gymSettings->gstin)): ?>
                                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 item-row margin-top-5">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control item_name" name="item_name[]"
                                                           placeholder="Item Name" value="<?php echo e(ucwords($item_name)); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="" class="form-control cost_per_item"
                                                           name="cost_per_item[]" value="<?php echo e($item_price); ?>" placeholder="Cost per item">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2 border-dark  text-center">
                                            ...
                                            <p class="form-control-static"><i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span
                                                        class="amount-html"><?php echo e($item_price); ?></span></p>
                                            <input type="hidden" class="amount" name="amount[]" value="<?php echo e($item_price); ?>">
                                        </div>
                                    ...
                                    <div class="col-xs-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2" >
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="sub-total"><?php echo e($item_price); ?></span>
                                            </p>


                                            <input type="hidden" class="sub-total-field" value="<?php echo e($item_price); ?>" name="sub_total">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-icon input-icon-md">
                                                    <i class="fa <?php echo e($gymSettings->currency->symbol); ?> font-grey-mint"></i>
                                                    <input type="number" min="0" class="form-control discount-amount" name="discount_amount" value="<?php echo e($discount); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <?php if($gymSettings != '' && !is_null($gymSettings->gstin)): ?>
                                        ...
                                        <div class="row margin-top-5 sbold">
                                            ...
                                            <p class="form-control-static col-xs-6 col-md-2" >
                                                <i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="total"><?php echo e($item_price-$discount); ?></span>
                                            </p>


                                            <input type="hidden" class="total-field" value="<?php echo e($item_price-$discount); ?>" name="total">
                                        </div>
                                        ...
                                        <div class="row margin-top-5">
                                            <div class="form-group col-md-2 col-md-offset-10">
                                                    ...
                                                    <input type="text" readonly class="form-control" name="generated_by" id="generated_by" value="<?php echo e(ucwords($user->first_name.' '.$user->last_name)); ?>" >
                        ...
                        <div class="form-group form-md-line-input has-success">
                            ...
                            <div class="col-md-6">
                                <div class="input-icon right">
                                    <input type="text" class="form-control" placeholder="GSTIN" id="gstin" name="gstin" value="<?php if($gymSettings !=''): ?><?php echo e($gymSettings->gstin); ?><?php endif; ?>">
...
<?php $__env->startSection('footer'); ?>
    ...
    <?php echo HTML::script('admin/global/plugins/typeahead/handlebars.min.js'); ?>

    <?php echo HTML::script('admin/global/plugins/typeahead/typeahead.bundle.min.js'); ?>
            ...
            var handleTwitterTypeahead = function() {
                ...
                var numbers = new Bloodhound({
                    ...
                    local: [
                        ...
                        { num: '<?php echo e(ucfirst($mem->title." - ".$mem->subCategory->Category->name)); ?>' },
    ...
    <script>
        ...
        $('#save-form').click(function(){
            $.easyAjax({
                url:'<?php echo e(route('gym-admin.gym-invoice.save-invoice')); ?>',
        ...
        $('#add-item').click(function () {
            var item = '<div class="col-xs-12 item-row margin-top-5">'
                ...
                + '<label class="control-label hidden-md hidden-lg">Amount</label>'
                + '<p class="form-control-static"><i class="fa <?php echo e($gymSettings->currency->symbol); ?>"></i><span class="amount-html">0</span></p>'
