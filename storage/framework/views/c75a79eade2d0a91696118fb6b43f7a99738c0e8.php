                                ...
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" placeholder="First Name" name="first_name" id="fisrt_name" value="<?php echo e($user->first_name); ?>">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" placeholder="Last Name" name="last_name" id="last_name" value="<?php echo e($user->last_name); ?>">
                                            <div class="form-control-focus"> </div>
                                    ...
                                    <div class="form-group form-md-radios">
                                        ...
                                        <div class="col-md-6">
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" id="male" name="gender" value="male" class="md-radiobtn" <?php if($user->gender == 'male'): ?> checked="checked" <?php endif; ?>>
                                                    <label for="male">
                                                        <span></span>
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="female" name="gender" value="female" class="md-radiobtn" <?php if($user->gender == 'female'): ?>checked="checked" <?php endif; ?>>
                                                    <label for="female">
                                                        <span></span>
                                                        <span class="check"></span>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="tel" class="form-control" placeholder="Mobile number" id="mobile" name="mobile" value="<?php echo e($user->mobile); ?>">
                                            <div class="form-control-focus"> </div>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="email" class="form-control" placeholder="Email" id="email" name="email" value="<?php echo e($user->email); ?>">
                                            <div class="form-control-focus"> </div>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input readonly name="date_of_birth" id="date_of_birth" type="text"  class="form-control  date-picker" data-date-format="yyyy-mm-dd"  placeholder="Date of birth" value="<?php if(!is_null($user->date_of_birth)): ?><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d', $user->date_of_birth)->format('Y-m-d')); ?><?php endif; ?>">
                                            <div class="form-control-focus"> </div>
...
$('#updateProfile').click(function(){
    $.easyAjax({
        url: '<?php echo e(route('gym-admin.profile.store')); ?>',
