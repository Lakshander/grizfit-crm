                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="actions col-sm-2 col-xs-12">
                                ...
                                <a href="<?php echo e(route('gym-admin.membership-payment.create')); ?>" id="add_payment" class="btn dark"> add <span class="hidden-xs">payment</span>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        function loaddeleted_dataTable()
        {
            ...
            table.dataTable({
                responsive: true,
                "sAjaxSource": "<?php echo e(route('gym-admin.membership-payment.ajax-create-deleted')); ?>",
                bDestroy:true,
                "aoColumns": [
        ...
        function load_dataTable()
        {
            ...
            table.dataTable({
                responsive: true,
                "sAjaxSource": "<?php echo e(route('gym-admin.membership-payment.ajax-create')); ?>",
                bDestroy:true,
                "aoColumns": [
                    { 'sClass': 'center', "bSortable": true, "width":"20%"  },
                    { 'sClass': 'center', "bSortable": true  },
