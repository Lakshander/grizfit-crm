                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    <a class="btn btn-danger add-pending-btn-gap" href="<?php echo e(route('gym-admin.client-purchase.pending-subscription')); ?>">Pending Subscription (<?php echo e($pendingCount); ?>)</a>
...
<?php $__env->startSection('footer'); ?>
    ...
    // begin first table
    table.DataTable({
    "sAjaxSource": "<?php echo e(route('gym-admin.client-purchase.ajax-create')); ?>",
    bDestroy:true,
    "aoColumns": [
