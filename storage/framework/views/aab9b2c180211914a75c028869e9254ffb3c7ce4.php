                    ...
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                        ...
                        <div class="widget-thumb-wrap">
                            ...
                            <div class="widget-thumb-body">
                                ...
                                <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?php echo e($emailsTotal); ?>">0</span>
                            </div>
                        </div>
                    </div>
                    <!-- END WIDGET THUMB -->
                ...
                <div class="col-md-3">
                    ...
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                        ...
                        <div class="widget-thumb-wrap">
                            ...
                            <div class="widget-thumb-body">
                                <span class="widget-thumb-subtitle">Count</span>
                                <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?php echo e($campaignsTotal); ?>">0</span>
                            </div>
                        </div>
                    </div>
                    <!-- END WIDGET THUMB -->
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="actions col-sm-2 col-xs-12">
                                ...
                                <a href="<?php echo e(route('gym-admin.email-promotion.create')); ?>" class="btn dark"> new <span class="hidden-xs">campaign</span>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        function load_data_table(){
            ...
            var url = '<?php echo e(route('gym-admin.email-promotion.ajax-promotions')); ?>';
            // begin first table
            // begin first table
            table.dataTable({
                responsive: true,
