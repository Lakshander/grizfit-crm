    ...
    <?php $__env->startSection('CSS'); ?>
        <?php echo HTML::style('admin/apps/css/todo-2.css'); ?>

        <?php echo HTML::style('admin/admin/layout3/css/custom.min.css'); ?>
        ...
        <?php echo HTML::style('admin/global/plugins/select2/select2-bootstrap.min.css'); ?>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-8 col-sm-8">
                                                                    <div class="todo-taskbody-user">
                                                                        <?php if($user->image ==''): ?>
                                                                            <img src="<?php echo e(asset('/fitsigma/images/').'/'.'user.svg'); ?>" class="todo-userpic pull-left" width="50px" height="50px"/>
                                                                        <?php else: ?>
                                                                            <img src="<?php echo e($profilePath.$user->image); ?>" class="todo-userpic pull-left" width="50px" height="50px"/>
                                                                        <?php endif; ?>
                                                                        <span class="todo-username pull-left"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></span>
                                                                    </div>
                                                                </div>
    ...
    <?php $__env->startSection('footer'); ?>
        <?php echo HTML::script('admin/apps/scripts/todo-2.min.js'); ?>

        <?php echo HTML::script('admin/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js'); ?>

        <?php echo HTML::script('admin/global/plugins/bootstrap-daterangepicker/moment.min.js'); ?>

        <?php echo HTML::script('admin/global/plugins/select2/select2.js'); ?>
        ...
        <script>
            ...
            function taskLoad(page) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('gym-admin.task.loadmoretask')); ?>",
                    cache: false,
                    data: {
                        'page': page,
                        'data': data,
            ...
            function show(id) {
                var url = '<?php echo e(route('gym-admin.task.edit',':id')); ?>';
            ...
            function addUpdate() {
                ...
                var url;
                if(id == '') {
                    url = '<?php echo e(route('gym-admin.task.store')); ?>';
                } else {
                    url = '<?php echo e(route('gym-admin.task.update',':id')); ?>';
                    url = url.replace(':id',id);
                }
            ...
            function deleteTask(id) {
                ...
                var url = '<?php echo e(route('gym-admin.task.destroy',':id')); ?>';
                url = url.replace(':id',id);
