<?php $__env->startSection('CSS'); ?>
    <?php echo HTML::style('admin/global/plugins/bootstrap-summernote/summernote.css'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('gym-admin.email-promotion.index')); ?>">Email Promotions</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                        ...
                        <div class="portlet-body">
                            ...
                            <div id="select-template-section">
                                ...
                                <?php $__currentLoopData = $emailTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="email-template-list template-div-<?php echo e($template->id); ?>">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-1" style="padding-top: 6%">
                                                    <div class="md-checkbox has-info" style="margin-left: 50%;">
                                                        <input type="checkbox" name="template_id"
                                                               ...
                                                               id="template-<?php echo e($template->id); ?>"
                                                               class="md-check">
                                                        <label for="template-<?php echo e($template->id); ?>">
                                                            <span></span>
                                                ...
                                                <div class="col-md-9" style="padding-top: 4%">
                                                    <h4 class="sbold col-md-12"><?php echo e(ucwords($template->template_name)); ?></h4>

                                                    <div class="col-md-8">
                                                        <?php echo e(ucfirst($template->description)); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                <div class="mt-card-avatar mt-overlay-1">
                                                                    <img src="<?php echo e(asset('admin/gym-email-template/'.$template->image)); ?>"
                                                                         class="img-reponsive">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <div name="summernote" id="summernote_1">Write you email content here!</div>
                            ...
                            <div id="select-recipient-section" style="display: none">
                                ...
                                <?php echo Form::open(['id'=>'sendPromotionForm','class'=>'ajax-form']); ?>
                            ...
                            <div id="campaign-complete" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <a href="<?php echo e(route('gym-admin.email-promotion.index')); ?>" class="btn green"> Show All Campaigns <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <?php echo HTML::script('admin/global/plugins/bootstrap-summernote/summernote.min.js'); ?>
    ...
    <script>
        ...
        $('.preview-template').click(function () {
            ...
            var show_url = '<?php echo e(route('gym-admin.email-promotion.preview-template',['#templateId'])); ?>';
        ...
        $('#edit-campaign').click(function () {
            ...
            var url = '<?php echo e(route('gym-admin.email-promotion.show',[':id'])); ?>';
        ...
        saveCampaign.click(function () {
            var url = '<?php echo e(route('gym-admin.email-promotion.store')); ?>';
            $.easyAjax({
                url : url,
                type:'POST',
                data: {
...
//        Show live preview
    ...
    <script>
        ...
        function ajaxPromotion() {
            ...
            $.easyAjax({
                'url':'<?php echo e(route('gym-admin.email-promotion.sendPromotion')); ?>',
        ...
        function load_data_table(id) {
            ...
            var url = '<?php echo e(route('gym-admin.promotion.ajax-create',['#id'])); ?>';
